...
export default function PersonalTours() {
  ...
  const filtered = allTours.filter((t) => {
    ...
    return catMatch && (t.title.toLowerCase().includes(q) || t.destinations.toLowerCase().includes(q));
  });
  ...
  return (
    <div style={{ fontFamily: "'DM Sans', sans-serif", background: '#FAF6EF', minHeight: '100vh' }}>
      ...
      <div
        ...
        style={{
          height: '320px',
          background: 'linear-gradient(180deg, rgba(27,58,45,0.7) 0%, rgba(27,58,45,0.4) 100%), url(https://images.pexels.com/photos/3881104/pexels-photo-3881104.jpeg?auto=compress&cs=tinysrgb&w=1920) center/cover no-repeat',
        }}
      >
        <Navbar />
        <div className="relative z-10 px-4" style={{ marginTop: '60px' }}>
          ...
          >
            Personal <em style={{ fontStyle: 'italic', color: '#E8C97A' }}>Tours</em>
          </h1>
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="mb-10 flex flex-col gap-5">
          <div className="flex gap-4">
            ...
            <button
              className="flex items-center gap-2 px-6 py-3.5 bg-white rounded-xl"
          ...
          <div className="flex flex-wrap gap-3">
            {categories.map((cat) => (
              <button
                ...
                className={`cat-pill px-5 py-2 rounded-full font-semibold text-sm transition-all duration-300 ${selectedCategory === cat ? 'active' : ''}`}
                style={{
            ...
            >
              ...
              <div style={{ padding: '24px' }}>
                <div
                  ...
                  style={{
                    background: 'rgba(27,58,45,0.08)', color: typeColor[tour.type] || '#1B3A2D',
                ...
                <h3
                  style={{
                    fontFamily: "'Playfair Display', serif",
                    fontSize: '20px', fontWeight: 700, color: '#1B3A2D',
                    lineHeight: 1.2, margin: '0 0 10px',
                  }}
                >
                  {tour.title}
                </h3>
                <p style={{ fontSize: '13px', color: '#7A7265', margin: '0 0 16px' }}>📍 {tour.destinations}</p>

                <div className="flex items-center justify-between pt-4" style={{ borderTop: '1px solid #F0EAE0' }}>
                  <div>
                    <span style={{ fontFamily: "'Playfair Display', serif", fontSize: '26px', fontWeight: 700, color: '#1B3A2D' }}>
                      ₹{tour.price}
                    </span>
                  ...
                  <button
                    ...
                    style={{
                      background: '#1B3A2D', color: 'white', padding: '10px 20px',
